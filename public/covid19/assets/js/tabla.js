...
const dataPChartColumns=(dataModelOrdenadaCortada)=>{
  ...
  //console.log(columnConfirmed);
  //console.log(columnDeaths);
  //console.log(columnRecovered);
  ...
  console.log([cActive, cConfirmed, cDeaths, cRecovered].flat());
...
const chartColumn = (dataColumns) => {
    console.log("constructor de grafico: ",dataColumns);
